      ...
      <div className="font-Karla font-regular pt-20">
        <div className=" flex justify-center  mx-20">
          <div className="pt-20 px-10 w-2/5">
            ...
            <h1 className="text-3xl text-left text-[#265479] py-4">Download</h1>
        ...
        <div className="flex justify-left mx-20">
          <div className="pt-20 px-10 w-[76%]">
            <h1 className="text-3xl text-left text-[#265479] py-4">Examples</h1>

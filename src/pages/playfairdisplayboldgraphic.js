        ...
        <div key={font} className="flex justify-center mx-20">
          <div className="pt-20 px-10 w-2/5">
            ...
            <p className="text-xl py-6 text-[#0F0800]">
              This a chapter opener from a book made by Allie Zhang called On My
              Way Home. This chapter opener needs to go well with the font
              chosen for the body text, which is Karla, a san-serif typeface
              with rounder shapes. Pairing this rounder san-serif font with a
              rounded-edged serif font is a good choice.
            </p>
